...
public class Main {
    ...
    private static void exercise1() {
        ...
        String myName = "Francesco Bignardi";
        System.out.println(myName.toLowerCase() + " " + myName.toUpperCase());
    }
    ...
    private static void exercise2() {
        ...
        String middleName = "Luigi";
        String lastName = "Bignardi";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "" + number1 + trueOrFalse + 1.5; // <--- Edit this line
