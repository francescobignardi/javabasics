...
public class Main {
    ...
    private static void exercise1() {
        ...
        int ourNumberInt = Integer.valueOf(ourNumberStr);    //converto ourNumberStr in un integer
        int newNumber = ourNumberInt + 2;                    //dichiaro nuova variabile e sommo ourNumberInt a 2
        String finalNumber = String.valueOf(newNumber);      //dichiaro variabile finale e la converto in stringa
    ...
    private static void exercise3() {
        ...
        String doubleStrToConvert = "1.2"; // Also this line
    ...
    private static void exercise4() {
        System.out.println("\nExercise 4:");
        String startStr = "5 ";
        String clean = startStr.trim();                    //con trim tolgo lo spazio dopo il 5
        int startInt = Integer.valueOf(clean);             //converto in integer
        int timedInt = startInt * 2;                       //moltiplico per 2 istanziando una nuova variabile
        String backToString = String.valueOf(timedInt);    //riconverto in stringa
        String concatenate = backToString + backToString;  //concateno le due stringhe 10 e 10 formando 1010
        Double nowDouble = Double.valueOf(concatenate);    //converto in double
        Double stillDouble = nowDouble / 3.5;              //divido il double per 3.5
        Double cleanedNumber = Math.floor(stillDouble);    //con Math.floor tolgo i decimali
        System.out.println(cleanedNumber);                 //stampo il numero finale
