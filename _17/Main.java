...
public class Main {
    ...
    private static void exercise1() {
        ...
        long myBankBalanceEuroLong = Long.valueOf(myBankBalanceEuro);
        myBankBalanceEuroLong = myBankBalanceEuro + questionableFundsEuro;
    ...
    static void myDate() {
        ...
        String getMonth = String.valueOf(currentDate.getMonth());
        System.out.println(getMonth);

        int getMonthValue = currentDate.getMonthValue();
        System.out.println(getMonthValue);

        LocalDate date1 = LocalDate.of(1992, 10, 12);
        if(date1.isBefore(currentDate)){
            System.out.println("Il 12/10/92 è nel passato");
        } else {
            System.out.println("Il 12/10/92 è nel futuro");
        }
