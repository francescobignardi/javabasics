...
public class Main {
     ...
     * A1: do while, perché vogliamo che almeno una azione avvenga qualunque sia la condizione
     *
     * Q2: We have a list of 1000 users to send emails to
     * A2: uno dei due cicli for
     *
     * Q3: We want to print out the first 80 customer names from our bank database
     * A3: for i forse è il più comodo
     *
     * Q4: We want to read a file 100 lines at a time, without loading the full file into our program
     * A4: while, perché non sappiamo quanto è grande il file e un ciclo for potrebbe essere inadeguato
     */
}
